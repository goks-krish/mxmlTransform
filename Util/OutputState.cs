...
namespace mxmlTransform.Mxml.Util
{
    ...
    /// </summary>
    /// <remarks>Only <c>xml</c> and <c>text</c> and <c>html</c> methods are supported by this version of 
    /// the <c>MultiXmlTextWriter</c>.</remarks>
    internal enum OutputMethod { Xml, Text, Html };

    /// <summary>
    /// This class represents redirected output state and properties.
    /// </summary>  
    internal class OutputState {            
        private HtmlTextWriter xmlWriter;                        
        ...
        public void InitWriter() {
            ...
            if (method == OutputMethod.Xml) {
                xmlWriter = new HtmlTextWriter(href, encoding);
                if (indent)
        ...
        public HtmlTextWriter XmlWriter {
